...
export default function Player(props) {
    ...
    return (
        <View style={styles.player}>
            <TouchableOpacity onPress={() => handleBack()} style={{ marginRight: 20, marginLeft: 20, marginBottom: 20 }}>
                <AntDesign name="banckward" size={25} color="white" />
            </TouchableOpacity>
            {
                (!props.playing) ?
                    <TouchableOpacity onPress={() => handlePlay()} style={{ marginRight: 20, marginLeft: 20, marginBottom: 20 }}>
                        <AntDesign name="playcircleo" size={25} color="white" />
                    </TouchableOpacity>
                    :
                    <TouchableOpacity onPress={() => handlePause()} style={{ marginRight: 20, marginLeft: 20, marginBottom: 20 }}>
                        <AntDesign name="pausecircleo" size={25} color="white" />
                    </TouchableOpacity>

            }
            <TouchableOpacity onPress={() => handleNext()} style={{ marginRight: 20, marginLeft: 20, marginBottom: 20 }}>
